...
import com.example.ticketsystem.repositories.*;
import com.example.ticketsystem.services.interfaces.OrdersService;
...
public class OrderServiceImpl implements OrdersService {
    ...
    public ApiResponse<OrderResponse> addNew(CreateOrderRequest request) {
        try {
            ...
            Long total = ((long) request.getQuality() * film.getPrice()) * (100 - discount) / 100L;// cái này do json nó ko cho nhhap % nên tuiđể ố thường xong xử lý logicđổi than % h method này nhé
                                       //thg quality là quantiy nhé =))
